...
class Messages: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let t221 = NSLocalizedString("So you'll give me an answer. If YOU are still alive!", comment: "So you'll give me an answer. If YOU are still alive!")
        ...
        let t222 = NSLocalizedString("Guess kkk", comment: "Guess kkk")
        ...
        let t223 = NSLocalizedString( "Hey", comment: "Hey")
        ...
        let t224 = NSLocalizedString("Rachel!??!", comment: "Rachel!??!")
        ...
        let joshMessages = [Message(text: t92, owner: josh), Message(text: t93, owner: rachel), Message(text: t94, owner: josh), Message(text: t95, owner: rachel), Message(text: t96, owner: josh), Message(text: t97, owner: rachel), Message(text: t98, owner: josh), Message(text: t99, owner: rachel), Message(text: t100, owner: josh), Message(text: t101, owner: rachel), Message(text: t102, owner: josh), Message(text: t103, owner: rachel), Message(text: t104, owner: josh), Message(text: t105, owner: josh), Message(text: t106, owner: rachel), Message(text: t107, owner: josh), Message(text: t108, owner: rachel), Message(text: t109, owner: josh), Message(text: t110, owner: rachel), Message(text: t111, owner: josh), Message(text: t112, owner: rachel), Message(text: t113, owner: josh), Message(text: t114, owner: rachel), Message(text: t115, owner: josh), Message(text: t116, owner: rachel), Message(text: t117, owner: josh), Message(text: t118, owner: rachel), Message(text: t119, owner: josh), Message(text: t120 , owner: rachel), Message(text: t121, owner: rachel), Message(text: t122, owner: josh), Message(text: t123, owner: rachel), Message(text: t124, owner: josh), Message(text: t125, owner: rachel), Message(text: t126, owner: josh), Message(text: t127, owner: rachel), Message(text: t128, owner: josh), Message(text: t129, owner: rachel), Message(text: t130, owner: josh), Message(text: t131, owner: josh), Message(text: t132, owner: rachel), Message(text: t133, owner: josh), Message(text: t134, owner: rachel), Message(text: t135, owner: rachel), Message(text: t136, owner: josh), Message(text: t137, owner: rachel), Message(text: t138, owner: josh), Message(text: t139, owner: rachel), Message(text: t221, owner: josh)]
        
        let williamMessages = [Message(text: t140, owner: william), Message(text: t141, owner: rachel), Message(text: t142, owner: william), Message(text: t143, owner: rachel), Message(text: t144, owner: william), Message(text: t145, owner: rachel), Message(text: t146, owner: william), Message(text: t147, owner: rachel), Message(text: t148, owner: william), Message(text: t149, owner: rachel), Message(text: t150, owner: william), Message(text:t151 , owner: rachel), Message(text:t152 , owner: william), Message(text: t153, owner: rachel), Message(text: t154, owner: william), Message(text: t155, owner: william), Message(text: t156, owner: rachel), Message(text: t157, owner: rachel), Message(text: t158, owner: william), Message(text: t159, owner: rachel), Message(text: t160, owner: rachel), Message(text: t161, owner: william), Message(text: t162, owner: rachel), Message(text: t163, owner: william)]
        
        let momMessages = [Message(text: t164, owner: rachel), Message(text: t165, owner: mom), Message(text: t166, owner: rachel), Message(text: t167, owner: mom), Message(text: t168, owner: rachel), Message(text: t169, owner: mom), Message(text: t170, owner: rachel), Message(text: t171, owner: mom), Message(text: t172, owner: mom), Message(text: t173, owner: mom), Message(text: t174, owner: mom), Message(text: t175, owner: rachel), Message(text: t176, owner: rachel), Message(text: t177, owner: mom), Message(text: t178, owner: rachel), Message(text: t179, owner: mom),Message(text: t180, owner: mom), Message(text: t181, owner: rachel), Message(text: t182, owner: mom), Message(text: t183, owner: rachel), Message(text: t189, owner: mom), Message(text: t190, owner: rachel), Message(text: t191, owner: mom), Message(text: t192, owner: rachel), Message(text: t193, owner: mom), Message(text: t194, owner: rachel), Message(text: t195, owner: mom), Message(text: t196, owner: mom), Message(text: t197, owner: mom), Message(text: t198, owner: mom), Message(text: t199, owner: mom), Message(text: t200, owner: mom), Message(text: t201, owner: mom), Message(text: t202, owner: mom), Message(text: t203, owner: mom), Message(text: t204, owner: mom), Message(text: t205, owner: mom), Message(text: t206, owner: mom), Message(text: t207, owner: mom)]
        
        let annieMessages = [Message(text: t208, owner: annie), Message(text: t222, owner: rachel), Message(text: t209, owner: annie), Message(text: t210, owner: rachel), Message(text: t211, owner: annie), Message(text: t212, owner: rachel), Message(text: t213, owner: annie), Message(text: t214, owner: rachel), Message (text: t223, owner: annie), Message(text: t215, owner: annie), Message(text: t224, owner: annie), Message(text: t216, owner: annie), Message(text: t217, owner: annie), Message(text: t218, owner: annie), Message(text: t219, owner: annie), Message(text: t220, owner: rachel)]
